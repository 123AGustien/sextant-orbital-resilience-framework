...
a simulated recovery action is considered authorized.
============================================================
*/
...
window.lastExecutionGate = {
    ...
    reason: "Final human decision is required."
...
function runScenario(type){
    ...
    // ----------------------------------------
    // New scenario always requires new
    // human authorization.
    // ----------------------------------------
...
// ============================================================
// REFRESH COMPLETE OUTPUT AFTER HUMAN DECISION
// ============================================================
...
function refreshSystemOutputAfterHumanDecision(){
    ...
    // ----------------------------------------
    // REFRESH COMPLETE OUTPUT DISPLAY
    // ----------------------------------------
...
window.addEventListener(
    ...
    function(){
        ...
        Existing SIGNAL_LOSS startup behaviour
        is preserved.
