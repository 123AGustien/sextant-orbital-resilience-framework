...
const CommandCentreCoreV3 = {
    ...
    normalizeDomainOutput(domainOutput){
        ...
        1. Direct OrbitalEngine output
        2. Complete system output
        */
    ...
    evaluateExecutionGate(domainOutput){
        ...
        if(
            ...
            /*
            Additional hard safety validation.
            Even if a supplied gate says authorized,
            the supervisory core remains simulation-only.
            */
    ...
    act(domainOutput){
        ...
        A positive gate only means that the
        simulated action may be represented
        in the CTI screen.
        */
    ...
    process(
        ...
        /*
        Accept explicit input or use the latest
        completed orbital system output.
        */
    ...
    updateCTIScreen(){
        ...
        */
        ...
        const validationPassed =
            cti.verification.validationPassed;
    ...
    updateIntegrationStatus(){
        ...
        /*
        CTI v3 uses the element "integration".
        */
